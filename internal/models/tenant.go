...
type Tenant struct {
	...
	ApiKey               string     `gorm:"column:api_key;type:text;not null" json:"-"` // masked preview only; never the raw key
	ApiKeyHash           *string    `gorm:"column:api_key_hash;type:text;uniqueIndex" json:"-"`
